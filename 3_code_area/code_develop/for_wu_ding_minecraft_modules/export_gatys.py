...
# %%
style_img = Image.open('/home/zxt/Python_area/for_wu_ding_minecraft_modules/datas/1_origin_data/Van_Gogh.jpg')
...
def get_styles(image_shape, device):
    ...
    styles_Y, _ = extract_features(style_X, content_layers, style_layers)
...
# %%
device, image_shape = d2l.try_gpu(), (512,512)
net = net.to(device)
content_X, contents_Y = get_contents(image_shape, device)
_, styles_Y = get_styles(image_shape, device)
output = train(content_X, contents_Y, styles_Y, device, 0.3, 500000, 50)
