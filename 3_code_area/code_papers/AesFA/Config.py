class Config:
    ...
    content_dir = '/mnt/sda/zxt/3_code_area/0_code_hello/test_metirc3d/outputs/03/merge'
    style_dir = '/mnt/sda/zxt/3_code_area/code_papers/AesFA/img/birds_mai_multi_black_test/test2_150'
    ...
    if phase == 'test':
        ...
        style_dir = style_dir
        img_dir = './output/'+file_n+'/'+ '03' + '/' + 'test4'   #ouput dir, 代码会帮忙创建文件夹, 可以不用自己创建
