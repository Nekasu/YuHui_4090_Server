class Config:
    ...
    content_dir = '/mnt/sda/zxt/3_code_area/0_code_hello/test_metirc3d/outputs/cameraman/merge'
    style_dir = '/mnt/sda/zxt/3_code_area/code_papers/AesFA/img/main_style_black'
    ...
    if phase == 'test':
        ...
        style_dir = style_dir
        img_dir = './output/'+file_n+'/'+ 'cameraman'+'/'+ 'test3' + '/' + 'main'   #ouput dir, 代码会帮忙创建文件夹, 可以不用自己创建
